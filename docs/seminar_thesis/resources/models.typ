...
#let drone_model(plus_config) = {
  ...
  ortho(z: z_rot, y: y_rot, x: x_rot, sorted: false, {   
    ...
    for (i, (x_rotor, y_rotor)) in rotor_positions.enumerate() {
      ...
      if plus_config {
        content((0.7, -0.5, 1.6), [$M_#(i+1)$])
      } else {
        content((-0.3, 0.3, 1.6), [$M_#(i+1)$])
      }
    ...
    // z-Achse
    line((0, 0), (0, 0, 2.5), mark: (end: "stealth"))
    ...
    for (i, (x_rotor, y_rotor)) in rotor_positions.enumerate() {
      ...
      line((0, 0, -0.4), (0, 0, -1.8), mark: (end: "stealth"))
      content((-0.3, 0.15, -1.1), [$F_#(i+1)$])
      for j in range(3) {
        merge-path(fill: white, {
    ...
    content((-0.3, -0.1), $K_B$, anchor: "east")
    ...
    if plus_config {
      translate((-3.0, 2.3, 0.5))
      circle((0, 0), radius: 0.05, fill: black)
      content((-0.3, -0.3), $K_E$, anchor: "east")
      line((0, 0, 0), (1, 0), mark: (end: "stealth"))
      content((), $x$, anchor: "east")
      line((0, 0), (0, 1), mark: (end: "stealth"))
      content((), $y$, anchor: "west")
      line((0, 0), (0, 0, 1), mark: (end: "stealth"))
      content((), $z$, anchor: "south")
      }
    })
})
